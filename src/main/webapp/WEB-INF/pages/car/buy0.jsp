...
<div style="border-left:1px solid #e6e6e6;border-right:1px solid #e6e6e6;padding-top:10px;padding-bottom:30px;">
    ...
    <div class="selection" style="padding-top:10px;padding-bottom:10px;border-bottom:1px solid #6e6e6e;">
        ...
        <select name="car_brand">
        	...
        	<c:forEach items="${map.brand}" var="item" varStatus="status">
        ...
        <select name="car_name">
            <option value="0">不限</option>
            <c:forEach items="${map.carName}" var="item" varStatus="status">
	            <option value="${item}">${item}</option>
            </c:forEach>
        </select>
        车型
        <select name="car_level">
            <option value="0">不限</option>
           <c:forEach items="${map.gearbox}" var="item" varStatus="status">
	            <option value="${item}">${item}</option>
            </c:forEach>
        </select>
        变速箱
        <select name="car_gearbox">
            <option value="0">不限</option>
           <c:forEach items="${map.level}" var="item" varStatus="status">
	            <option value="${item}">${item}</option>
            </c:forEach>
        </select>
...
<div class="carshow">
    <table class="table-detail">
        ...
        <tr>
            <c:forEach items="${pb}" var="item" varStatus="status" begin="0" end="19">
            <td class="car_td">
            <a  class="car_a" href="/page/details?id=${item.carId}">
            <div class="item_name" style="line-height: 30px;">${item.brand}  ${item.carName } </div>
